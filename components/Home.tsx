...
export const HomeComponent = () => {
  return (
    <div className="flex md:w-[500px md:h-auto]">
      <div
        id="home"
        className="flex-col w-full h-[90%] bg-firstbg bg-no-repeat  bg-auto bg-center m-auto"
      >
        <div className="flex items-center w-full h-screen justify-center">
          <div className="mb-[150px]">
            <div className=" flex-col ml-11  w-128 h-auto ">
              <h1 className="text-[9rem] flex font-bold tracking-tight sm:text-center text-white font-serif items-center  justify-center ">
                Suino
              </h1>
              ...
              <div className="h-[50px] mt-8 flex gap-x-5 sm:justify-center flex items-center  justify-center">
                <Link
                  href="game"
